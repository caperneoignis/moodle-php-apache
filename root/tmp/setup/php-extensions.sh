...
LIBS="locales libaio1 libcurl4 libgss3 libicu-dev default-libmysqlclient-dev libpq5 libmemcached11 libmemcachedutil2 libldap-2.4-2 libxml2 libxslt1.1 unixodbc libmcrypt-dev"
...
pecl install solr memcached redis apcu igbinary ${XDEBUG}
